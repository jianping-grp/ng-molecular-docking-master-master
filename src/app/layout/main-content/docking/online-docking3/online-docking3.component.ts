...
@Component({
  selector: 'app-online-docking3',
  templateUrl: './online-docking3.component.html',
  styleUrls: ['./online-docking3.component.css']
})
export class OnlineDocking3Component implements OnInit {
